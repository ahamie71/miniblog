...
$results = $db->query("SELECT * FROM posts ORDER BY created_at DESC LIMIT 0,3')
    ...
    <div class="page-container">
        ...
        <div class="posts">
            ...
            <div class="post-container">
                ...
                <div class="post">
                    <img src="images/image2.png" alt="" class="slider-image">
                    <div class="post-info">
                        <h4><a href="single.html">La vies est belle</a></h4>
                        <i> Ronas</i>
                        &nbsp;
                ...
                <div class="post">
                    <img src="images/image3.png" alt="" class="slider-image">
                    <div class="post-info">
                        <h4><a href="single.html">La vies est belle</a></h4>
                        <i> Ronas</i>
                        &nbsp;
