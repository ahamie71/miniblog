        ...
        <div class="posts">
            ...
            <div class="post-container">
               ...
               <?php foreach ($post as $posts):?>
                <div class="post">
                    <img src="<?php echo 'images/' .$posts['image']?>" alt="mon image" class="slider-image">
                    <div class="post-info">
                        <h4><a href="single.html"><?php echo $posts['title']?></a></h4>
                        <i><?php echo $posts['author']?></i>
                        &nbsp;
                        <i><?php echo $posts['created_at']?><</i>
                    </div>
                </div>
                <?php endforeach; ?>
        ...
        <div class="footer">
            <div class="footer-content">
                ...
                <div class="footer-section about">
                    <h1 class="logo-text"><span>READ</span>BLOG</h1>
                    <p>
                        READBLOG est un petit blog conçu pour un objectif de tutoriel sur Youtube.
